...
cards = {
    ...
    "ace-hearts": [[195, 335], [40, 260]],
    "king-hearts": [[195, 335], [280, 505]],
    "queen-hearts": [[195, 335], [515, 760]],
    "jack-hearts": [[195, 335], [780, 1020]],
    "ten-hearts": [[195, 335], [1040, 1280]],
    "nine-hearts": [[195, 335], [1300, 1540]],
    "eighth-hearts": [[195, 335], [1560, 1800]],
    "seven-hearts": [[195, 335], [1820, 2060]],
...
class GetCheckGameType:
    ...
    def __init__(self, img_path):
        ...
        blured_img = cv2.GaussianBlur(contrasted_img, [5, 5], 0)
        grayImage = cv2.cvtColor(blured_img, cv2.COLOR_BGR2GRAY)
        self.thresh, self.img = cv2.threshold(grayImage, 170, 255, cv2.THRESH_BINARY)
